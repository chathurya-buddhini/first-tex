...
public static void main(String[]args){
	Student S1 = new Student();
	    ...
	    System.out.println("dbm: " + S1.getDbm());
	}	
	}
class Student{
	 private String Name;
	...
	public void volume(String Name,int ID,int prf,int dbms) {
		this.Name =Name;
		this.ID =ID;
		this.prf=prf;
		this.dbms=dbms;
...
class Car{
	...
	public void volume(String brade,int wheels) {
		this.brade = brade;
		this.wheels =wheels;
...
class Box{
  ...
  public void printVolume() {
   ...
   public void printVolume1(int length,int width) {
		int volume1 = (length * width)*6;
...
Array List ---> object type array eka me class eka athule thiyenava.

public class ArrayListDemo{

public static void main(String args[]){
   
   ArraysList arrayList = new ArrayList();
   arrayList.add(10);
   arrayList.add("Dilshan");
   
   System.out.print(arrayList.get(0));

    ArraysList <Integer> studentList = new ArrayList<>();
   studentList.add(10);
   studentList.add(20);
   studentList.add("Kanmal");//Illegel
   
    ArraysList <Integer> nametList = new ArrayList<>();
   nametList.add("Dilshan");
   nametList.add("Kamal");
   nametList.add(10);//Illegel
   
   
   **me hama method ekak ganna kalin import karaganna ona**
   
   import java.util.ArrayList;
   import java.util.Collection;
   
   Collection <Integer> numberList = new Collection<>();
   
   numberList.size(); // array length eka ganna puluwan
   
   numberList.isEmpty();// array eke values thiyeda kiyala chek karaganna 
   
  System.out.print("Contains"+ numberList.contains(10));// dena value eka thiyeda kiyala chek karanna 
  
  System.out.print(numberList);// array eka print wenava
  
  numberList.toArray();// array list eke hadana object eke clone ekak ganna puluwan
  
  numberList.remove(10);//array eke thiyena value remove karaganna puluwan and array eke ekak remove kala gaman length eken ekak adu wenava
  
  numberList.iterator();// An Iterator is an object that can be used to loop through collections, like ArrayList and HashSet. It is called an "iterator" because "iterating" is the technical term for looping.


  
  numberList.hasNext();// ilagata value thiyeda kiyala chek karanava
  
  numberList.Next();// next value eka print wenava
  
  numberList.hashCode();// object eke hashcode eka denava
  
  numberList.clear();// all clear wenava
  
  
  }
}	
Linked List ---> Linked List eka add karana hama kenama object ekak hadagena e hama object ekak hama ekakatama sambanda karanava 
